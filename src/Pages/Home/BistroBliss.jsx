...
const BistroBliss = () => {
    ...
    return (
        <div style={customStyle} className='h-[550px] bg-center mt-20 flex items-center justify-center'>
            <div className='h-2/3 bg-white mx-80 w-full flex justify-center items-center'>
